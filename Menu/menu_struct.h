...
// Start Menu
// Главное меню - Тесты
MAKE_MENU_ITEM(Tests, NULL_MENU_ITEM, TestConfig, NULL_MENU_ITEM, Reliability, NULL_ACTIVITY, "Тесты");
		//Подменю ур.1 - Безотказность
		MAKE_MENU_ITEM(Reliability, NULL_MENU_ITEM, Item12, Tests, NULL_MENU_ITEM, TEST_ACTIVITY, "Безотказность");
		MAKE_MENU_ITEM(Item12, Reliability, Item13, Tests, NULL_MENU_ITEM, NULL_ACTIVITY, "Пункт12");
		MAKE_MENU_ITEM(Item13, Item12, Item14, Tests, NULL_MENU_ITEM, NULL_ACTIVITY, "Пункт13");
...
static MenuItem_t *lastViewItem = &TestConfig;
